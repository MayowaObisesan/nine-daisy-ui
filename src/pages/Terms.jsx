...
const Terms = () => {
    return (
        <section className={"flex flex-column dark:bg-111314"}>
            <NavBar showAddAppButton={false} showSearch={false} />
            <section className={"fixed left-0 top-0 flex flex-row pct:w-100 vh:h-100 justify-center align-items-center"}>
                <div className={"font-32 font-bold dark:color-whitesmoke"}>Coming soon</div>
            </section>
            <section className={"d-block mg-x-auto pct:w-96 lg:pct:w-56 dark:color-whitesmoke opacity-40"} style={{ filter: "blur(4px)" }}>
                <header className={"font-16 font-bold pad-y4"}>Terms and Conditions</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>Conditions of use</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>Privacy policy</header>
                ...
                {/* <header className={"font-16 font-bold pad-y4"}>Age restriction</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>Intellectual property</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>User accounts</header>
                As a user of this website, you may be asked to register with us and provide private information. You are responsible for ensuring the accuracy of this information, and you are responsible for maintaining the safety and security of your identifying information. You are also responsible for all activities that occur under your account or password.
                If you think there are any possible issues regarding the security of your account on the website, inform us immediately so we may address them accordingly.
                We reserve all rights to terminate accounts, edit or remove content and cancel orders at our sole discretion.

                <header className={"font-16 font-bold pad-y4"}>Applicable law</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>Disputes</header>
                ...
                <header className={"font-16 font-bold pad-y4"}>Limitation on liability</header>
