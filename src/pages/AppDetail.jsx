...
function AppDetailContent(props) {
    ...
    const [appVersions] = useFetch(`${process.env.REACT_APP_BASE_URL}/app/version/?app=${props.id}`);
    const [screenshotPreviewImage, setScreenshotPreviewImage] = useState("");
    const [counter, setCounter] = useState(0);

    useEffect(() => {
        if (props.screenshot.length > 0) {
              ...
              {props.owner.firstname && props.owner.firstname[0].toUpperCase()}
                ...
                <a href={`mailto:${props.owner.email}`} id="id-app-owner-email"
                   className="block pl-8 pr-4 py-4 rounded-2xl radius hover:bg-base-200 hover:decoration-2 hover:underline-offset-2 hover:underline dark:hover:bg-base-300">
                    <span
                        className="fa fa-envelope w-8 h-8 leading-8 square-4 lh-4 pr-2 text-gray-500 color-999"></span>
                ...
                <div id="id-app-owner-email" className="pl-8 pr-4 py-4">
                    <span
                        className="fa fa-earth-africa w-8 h-8 leading-8 square-4 lh-4 pr-2 text-gray-500 color-999"></span>
        ...
        <img src={props.logo} alt={`${props.name} logo`} className="h-320 pct:w-88 bg-light gradient:to_top_right-lightgray-whitesmoke radius-top-left radius-top-right object-cover object-center" />
        {
          props.screenshot.map((image, index) => (
                    ...
                    className={"fixed top-20 flex flex-row flex-nowrap justify-around w-full h-[200px] z-0 every:text-center|h-240|radius-sm lg:relative lg:top-0 lg:h-[480px] lg:every:h-480"}>
                    {
                        props?.screenshot.length > 0
                            ? props?.screenshot.map((image, index) => (
                                <>
                                    <div key={index}
                                         className={"w-full h-[240px] mx-auto px-1 rounded-lg lg:h-[480px] lg:px-2"}>
                                        <img src={image.image}
            ...
            }
            {
                ...
                <section
                    ...
                    <section className={"w-[60%] h-[480px]"}>
                        <section
                            className={"relative flex flex-col justify-center bg-gray-10 bg-lighter px-0 py-0 rounded-2xl lg:p-2 lg:rounded-2xl dark:bg-base-200 dark:lg:mb-2"}>
                            {/* {
              ...
              size.windowWidth < deviceWidthEnum.laptop
                ...
                : null
                            ...
                            <div
                                className="flex flex-row flex-nowrap px-6 py-4 bg-base-100 rounded-xl radius overflow-x-auto lg:px-4 lg:py-2 lg:bg-inherit dark:bg-inherit">
                                {
                                    ...
                                    props.playstore_link !== ""
                                        ...
                                        >
                                            ...
                                            <div className="leading-tight text-left">
                                                ...
                                                <div
                                                    className={"font-semibold"}>{props.playstore_link ? "Google play store" : "-"}</div>
                                            </div>
                                            {/* {
                          size.windowWidth <= deviceWidthEnum.laptop
                          ...
                          size.windowWidth <= deviceWidthEnum.laptop
                            ...
                            : "Download from AppStore"
                                            ...
                                            <div className="leading-tight text-left">
                                                <div className={"text-[15px]"}>Download from</div>
                                                <div
                                                    className={"font-semibold"}>{props.playstore_link ? "Apple AppStore" : "-"}</div>
                                            </div>
                                        </ExternalLink>
                                        : null
                                }
                  ...
                  }
                  {
                    ...
                    <section
                        className={"relative flex flex-row flex-nowrap justify-center items-center bg-green-30 gap-4 flex-grow-0 w-[40%] px-12"}>
            ...
            <div class="bg-gradient-to-tl from-blue-50 via-blue-100 to-blue-50 blur- w-[90rem] h-[50rem] rounded-fulls origin-top-left -rotate-12 -translate-x-[15rem] dark:from-indigo-900/70 dark:via-indigo-900/70 dark:to-blue-900/70"></div>
                        ...
                        <div
                            className={"absolute w-64 h-72 rounded-xl bg-gradient-to-r from-violet-300/50 to-purple-100 dark:from-violet-900/50 dark:to-purple-900 blur-3xl"}></div>
                        <div className={"flex flex-col bg-white z-[1] dark:bg-base-300"}>
                            <div>
                                <div
                                    className={"app-banner-screenshot-preview w-ful h-[240px] px-4 rounded-lg lg:h-[360px] lg:px-2 z-[1]"}>
                                    <img
                            ...
                            <div className={"flex flex-row justify-center items-center"}>
                                {
                                    props?.screenshot.length > 0
                                        ? props?.screenshot.map((image, index) => (
                                            <>
                                                <div key={index}
                                                     className={"h-[24px] px-4 rounded-lg lg:h-[36px] lg:px-2 z-[1]"}>
                                                    <img src={image.image}
                                                         alt={`screenshot preview ${index}`} height={""}
                                                         className={"max-w-full w-full h-full object-contain object-center rounded-lg"}
            ...
            <section
                className={"w-full mx-auto lg:flex lg:flex-row lg:justify-between lg:items-start lg:w-full lg:px-8 dark:bg-inherit bg-orange-30"}>
                <section
                    className="app-banner-container relative top-[280px] w-full max-w-full overflow-y-auto m-auto bg-base-100 backdrop-blur-md rounded-2xl z-1 shadow:0px--20px-80px-20px-FFFFFF88 lg:top-[40px] lg:neg:top-80 lg:w-[56%] lg:mx-8 lg:ml-aut lg:bg-initial dark:shadow:0px--20px-80px-20px-11131488 dark:bg-base-300 dark:backdrop-blur-0">
              ...
              {props.category.split(',').map((each_app_category) => {
                return (<span
                  className="d-inline-block pad-x2 h-4 lh-4 mg-x1-smt radius-round bg-light font-normal font-10">{each_app_category}</span>)
                    ...
                    <section className={"space-y-3 rounded-xl bg-white dark:bg-base-300"}>
                        {
                            size.windowWidth < deviceWidthEnum.laptop &&
                            <section
                                className={"relative bg-gray-100 bg-lighter px-0 py-0 rounded-2xl lg:p-2 lg:rounded-2xl dark:bg-base-200 dark:lg:mb-2"}>
                                {
                                    /* For mobile, tablet and devices smaller than the laptop */
                                    size.windowWidth < deviceWidthEnum.laptop
                                        ? <div
                                            className="relative flex flex-row justify-start items-center pt-4 pb-0 px-2 font-bold text-4xl font-21 text-center rounded-xl bg-inherit z-2 dark:color-whitesmoke dark:every:bg-333334|color-whitesmoke">
                                            {
                                                props.logo
                                                    ? <img src={props.logo} alt={`${props.name} logo`}
                                                           className="block mx-4 my-4 w-16 h-16 bg-light rounded-full radius-circle object-cover object-center dark:bg-333334"/>
...

                        {
                            size.windowWidth < deviceWidthEnum.laptop &&
                            <section
                                className="app-download-details rounded-xl bg-base-100 pl-4 dark:bg-base-300 dark:p-0">
                                {/*<header className={"font-medium"}>{"Download links".toUpperCase()}</header>*/}
                                <section
                                    className={"flex flex-row justify-start gap-x-4 pt-5 pb-5 empty:pad-0 rounded-lg overflow-x-auto every:w-auto|h-64|radius|text-center|radius-inherit|decoration-none|bg-lighter|color-initial|mg-x1|pad-r4 hover:every:bg-E8E8E8|cursor-pointer dark:bg-inherit|pad-x2 dark:every:bg-333435|color-whitesmoke dark:hover:every:bg-333435"}>
                                    {
                ...
                }
                {
                    ...
                    : null
                        ...
                        <section className={"space-y-10 rounded-xl lg:bg-base-100 dark:bg-base-300"}>
                            <section className={"space-y-8 p-8 bg-base-10 rounded-xl dark:bg-base-200"}>
                                <header className={"relative font-semibold dark:font-bold text-xl"}>
                                    App Details
                                ...
                                <section className={"space-y-8"}>
                                    <div className={"space-y-2"}>
                                        ...
                                        <kbd
                                            className="kbd kbd-lg font-semibold">{props.current_version.version ?? "0.1.0"}</kbd>
                                    </div>
                                    <div className={"space-y-2"}>
                                        <div>Status:</div>
                                        <span
                                            className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-md font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/30 dark:text-blue-500">
                      <span className="w-1.5 h-1.5 inline-block rounded-full bg-blue-800 dark:bg-blue-500"></span>
                                    ...
                                    <div className={"space-y-2"}>
                                        <div>Phase:</div>
                                        <span
                                            className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-md font-medium bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500">
                      ...
                      Beta
                                    ...
                                    <div className="space-y-2 first:mt-0">
                                        ...
                                        <kbd className="kbd kbd-lg">
                                            {new Date(props.current_version.created_at).toDateString()}
                                    ...
                                    <div className={"space-y-2"}>
                                        <span>Website: </span>
                                        {
                                            ...
                                            && <ExternalLink url={props.website}
                                                             classes={"font-semibold text-xl hover:underline hover:decoration-2"}>{props.website} </ExternalLink>
                                        }
                                    </div>
                                    {/* <div>
                  ...
                  <ul className={"list-disc leading-10"}>
                    ...
                    <li>These features will roll out over the coming weeks.</li>
                                ...
                                <div>
                                    {
                                        props.current_version.latest_feature
                                    }
                                </div>
                            </section>

                            <section
                                className={"app-download-details flex flex-col mg-t-2 p-8 bg-white-solid rounded-xl dark:bg-base-200"}>
                                <header
                                    className={"radius text-3xl font-semibold py-4 lg:text-3xl lg:py-4 dark:color-whitesmoke"}>{"Download links"}</header>
                                <section
                                    ...
                                    >
                                        ...
                                        <span
                                            className={"pad-x1 lg:font-13 dark:color-whitesmoke"}>{props.playstore_link ? "Download from Google play store" : "-"}</span>
                                    </ExternalLink>
                                    ...
                                    >
                                        ...
                                        <span
                                            className={"pad-x1 lg:font-13 dark:color-whitesmoke"}>{props.appstore_link ? "Download from Apple AppStore" : "-"}</span>
                                    </ExternalLink>
                                    ...
                                    >
                                        ...
                                        <span
                                            className={"pad-x1 lg:font-13 dark:color-whitesmoke"}>{props.external_link ? "External Download" : "-"}</span>
                                    </ExternalLink>
                ...
                <a href={props.external_link || void (0)} target={"_blank"} rel={"noreferrer"} id="id-app-download-links"
                  ...
                  <span className={"pad-x1 lg:font-13 dark:color-whitesmoke"}>{props.external_link ? "External Download" : "-"}</span>
...

                    {
                        size.windowWidth < deviceWidthEnum.laptop
                            ? <section
                                ...
                                <Link
                                    to={props.owner.id === tokenData?.tokenData?.user_id ? "/profile" : `/user/${props.owner.id}`}
                                    className={"radius px-8 py-4 font-14 font-semibold dark:font-bold text-xl decoration-none color-initial dark:color-whitesmoke"}>
                                    {"Owner details"}
                    ...
                    {
                        size.windowWidth < deviceWidthEnum.laptop && userApps?.results?.length > 0
                        && <section
                            className={"app-download-details flex flex-col mt-4 py-8 bg-white dark:bg-222425 dark:bg-base-200 rounded-xl"}>
                            <header
                                className={"radius text-3xl font-semibold px-8 py-4 lg:text-3xl lg:px-4 lg:py-4 dark:color-whitesmoke"}>
                                {`More Apps by ${props.owner.firstname}`}
                            </header>
                            <section
                                className={"flex flex-row gap-5 px-4 py-5 every:d-block|decoration-none|pad-x2|pad-y3 overflow-x-auto"}>
                                {
                                    userApps?.results?.length > 0
                                        ...
                                        : <div className={"mg-x-auto mg-y1 pad-2 font-14 text-center color-gray"}>No apps
                                            yet</div>
                                }
                            </section>
                        </section>
                ...
                </section>
                {
                    size.windowWidth >= deviceWidthEnum.laptop
                        ? <section
                            className={"app-owner-details relative top-[40px] flex flex-col justify-start items-start bg-gray-100/40 p-2 rounded-xl mx-auto px:top-400 w-[400px] max-w-[480px] pct:w-32 dark:bg-base-300"}>
                            <section
                                className={"space-y-4 w-[100%] pct:w-80 mr-auto px-4 py-8 rounded-xl radius2 shadow lg:shadow-none bg-base-100 every:pad-y1 dark:bg-base-200"}>
                                <Link
                                    to={props.owner.id === tokenData?.tokenData?.user_id ? "/profile" : `/user/${props.owner.id}`}
                            ...
                            <section
                                className={"app-download-details flex flex-col mt-12 pad-y4 bg-white-solid dark:bg-222425 dark:bg-base-300"}>
                                <header
                                    className={"radius px-4 text-3xl font-semibold py-4 lg:text-2xl lg:py-4 dark:color-whitesmoke"}>{`Other apps from ${props.owner.firstname}`}</header>
                                <section
                                    className={"flex flex-col gap-6 px-4 py-5 every:d-block|decoration-none|pad-x2|pad-y3 overflow-x-auto"}>
                                    {
                                        userApps?.results?.length > 0
                                            ? userApps?.results.filter(t => t.id !== props.id).map((eachUserApps, index) => {
                                                return (
                                                    index < 3 ? <SearchAppBoxes key={eachUserApps.id} imageSize={"16"}
                                                                                truncateDescription={true}
                                                                                charsLength={48} {...eachUserApps} /> : null
                                                )
                                            })
                                            : <div
                                                className={"w-full mx-auto my-2 p-8 text-lg font-14 text-center rounded-xl bg-base-100 color-gray"}>No
                                                apps yet</div>
                                    }
                                </section>
                            </section>
...
function AppDetail() {
    ...
    return (
        <section id="id-app-details-fragment" className={"app-details-container h-full"}>
            ...
            <section
                className={"block h-full overflow-y-auto" + navigation.state === "idle" ? "opacity-40 next-page-animation" : ""}>
                {
